...
import 'package:flutter_nuedc_v2/controller/nuedc_controller.dart';
...
Future<void> main() async {
  ...
  Get.lazyPut<CameraManager>(() => CameraManager());
  ...
  Widget _opencvControlWidget() {
    return ListView(
      ...
      children: [
        ...
        FilledButton(onPressed: NUEDCController.doCNN, child: Text("CNN测试")),
        FilledButton(
          onPressed: NUEDCController.doClearCache,
          child: Text("清空缓存"),
        ),
      ],
    );
