...
class Object {
  Object({
    ...
    // if (rotation != null) rotation.copyIntc(this.rotation);
  ...
  final Quaternion rotation = Quaternion.euler(0.0, 0.0, 0.0);
  ...
  void updateTransform() {
    final Matrix4 m = Matrix4.compose(position, rotation, scale);
    transform.setFrom(m);
  }
